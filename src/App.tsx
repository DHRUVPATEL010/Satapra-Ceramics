...
function WhatsApp() {
  return (
    <a href="https://wa.me/919909986223" target="_blank" rel="noopener noreferrer"
      className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 bg-[#25D366]"
